  ...
  <head>
		<style type="text/css">
			...
			*/
			...
			.bottom-left-image { bottom: 100%; left: 0; margin-bottom: 7px; position: absolute; }
	...
	<body>
    	...
    	<?php
				...
				if ( $page_one_left ) {
					...
					if ( $image[1] >= '550' ) {
						...
						echo '<img class="bottom-image-image" src="' . $resize_src . '?resized&width=550&crop=true" width="220" />';
					}
				}
			?>
    	...
    	<?php
				...
				if( $page_two_left ) {
					...
					if( $image[1] >= '550' ) {
						$resize_src = get_attachment_link( $img_array[0] );
						echo '<img class="bottom-left-image" src="' . $resize_src . '?resized&width=550&crop=true" width="220" />';
					}
				}
			?>
